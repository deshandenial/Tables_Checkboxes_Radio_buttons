...
public class Extracting_values_from_a_cell {
	...
	//  Find the //No.of Columns
		...
		WebElement tableRow = baseTable.findElement(By.xpath("//div[@class='dataTables_wrapper']/table/tbody/tr[3]"));
		String rowtext = tableRow.getText();
		System.out.println("Third row of table:\t"+rowtext+"\t");
		
		WebElement cellIneed = tableRow.findElement(By.xpath("//div[@class='dataTables_wrapper']/table/tbody/tr[3]/td[2]"));
